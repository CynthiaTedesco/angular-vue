    ...
    return (_ctx, _cache) => {
      return (
        ...
        createElementBlock(
          "div",
          null,
          "Header from Vue " + toDisplayString(_ctx.title),
          1
        )
      );
    };
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
  ["styles", [_style_0]],
  ["__scopeId", "data-v-a06e0709"],
]);
    ...
    return (_ctx, _cache) => {
      return (
        ...
        createElementBlock(
          "button",
          { onClick: increment },
          "Clicked " + toDisplayString(count.value) + " times",
          1
        )
      );
    };
...
customElements.define(
  "vue-header",
  /* @__PURE__ */ defineCustomElement(Header)
);
customElements.define(
  "vue-button",
  /* @__PURE__ */ defineCustomElement(_sfc_main)
);
